  ...
  return (
    <div className="pagination-container">
      ...
      <a
        ...
        className={`pagination-btn ${currentPage === 1 ? 'bg-gray-100 text-gray-400 cursor-not-allowed' : 'hover:bg-gray-50'}`}
      ...
      <a
        href={`?page=${currentPage + 1}${category ? `&category=${category}` : ''}${selectedBrands ? `&brand=${selectedBrands}` : ''}`}
        className={`pagination-btn ${currentPage === totalPages ? 'bg-gray-100 text-gray-400 cursor-not-allowed' : 'hover:bg-gray-50'}`}
