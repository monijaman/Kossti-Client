...
const DarkModeToggle = () => {
  ...
  return (
    <button
      ...
      className="relative flex items-center justify-center w-9 h-9 rounded-full bg-gray-100 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 transition-colors duration-200 flex-shrink-0"
    >
      {isDark ? (
        // Sun icon
