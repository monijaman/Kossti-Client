...
const ProductDetails = ({ products, countryCode }: ProductDetailsProps) => {
  ...
  if (productList.length === 0) {
    return (
      <div className="overflow-x-auto">
        <div className="min-w-full bg-white dark:bg-gray-800 shadow-lg rounded-lg overflow-hidden p-6">
  ...
  return (
    <div className="overflow-x-auto">
      <div className="min-w-full bg-white dark:bg-gray-800 shadow-lg rounded-lg overflow-hidden">
