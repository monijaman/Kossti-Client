  ...
  return (
    <div className="min-h-screen flex flex-col mx-auto bg-transparent" suppressHydrationWarning>
      ...
      <div className="flex flex-col md:flex-row flex-grow bg-transparent">
        ...
        <main className="flex-1 bg-gray-100 p-3 md:p-4 lg:p-6">
          {children}
        </main>
      </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
            ...
            <div className="space-y-4">
              ...
              <div className="flex space-x-3 pt-2">
                <a href="https://www.facebook.com/profile.php?id=61572569735552" className="bg-gray-700 hover:bg-blue-600 p-2 rounded-lg transition-colors" aria-label="Facebook">
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <Link href={withLocale('/editorial-policy')} className="text-gray-300 hover:text-blue-400 transition-colors text-sm flex items-center group">
                    <svg className="w-4 h-4 mr-2 text-blue-600 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                    </svg>
